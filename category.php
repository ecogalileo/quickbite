...
<section class="page-section" id="menu">
    <h1 class="text-center text-cursive" style="font-size:3em"><b>
            <?= $data['name'] ?? "" ?>'s Menu
        </b></h1>
    ...
    <div class="row mx-0">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div id="menu-field" class="card-deck px-2 py-3 justify-content-center">
                ...
                $limit = 100;
                $page = (isset($_GET['id']) && isset($_GET['_page']) && $_GET['_page'] > 0) ? $_GET['_page'] - 1 : 0;
        ...
        <div class="w-100 mx-4 d-flex justify-content-center">
            <div class="btn-group paginate-btns">
                ...
                <a class="btn btn-default border border-dark" <?php echo (($page + 1) == $page_btn_count) ? 'disabled' : '' ?>
                    href="./?_page=<?php echo ($page + 2) ?>&_category<?php echo $_GET['id'] ?>">Next</a>

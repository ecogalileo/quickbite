...
<style>
  ...
  header.masthead-category:before {
    content: "";
    width: 100%;
    height: 100%;
    position: absolute;
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 text-dark" id="mainNav">
    <div class="container">
      ...
      </a> <img class="main-nav-logo" src="assets\img\logo.png">
        ...
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          if ($categories->num_rows > 0):
            ...
            <li class="nav-item dropdown">
              <a class="text-decoration-none nav-link" href="javascript:void(0)" class="dropbtn">Categories</a>
          ...
          <?php if (isset($_SESSION['login_user_id'])): ?>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="index.php?page=shopping_bag">
                <?php echo "My order" ?> <i class="fas fa-shopping-bag"></i>
              </a>
            </li>
            <li class="nav-item">

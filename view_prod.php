	...
	<div class="card ">
		...
		<div class="card-body">
			...
			<div class="row">
				...
				<input type="number" readonly value="<?php echo $qry['price'] ?>" class="form-control text-center price" name="price">
			</div>
			<br>
...
<script>
	...
	$('#add_to_cart_modal').click(function () {
		...
		$.ajax({
			...
			method: 'POST',
			data: { pid: '<?php echo $_GET['id'] ?>', qty: $('[name="qty"]').val(), price: $('[name="price"]').val() },

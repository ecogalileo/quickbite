								...
								<div class="col-md-4 text-right">
									<b>
										<large>
											...
											<input type="text" readonly value="<?php echo $row['qty'] * $row['price'] ?>" class="form-control text-center" name="total" hidden>
										</large>
									</b>
								</div>
							</div>
					...
					<div class="card">
						<div class="card-body">
							...
							<p class="text-right"><b>
									...
									<input type="number" readonly value="<?php echo $total ?>" min=1 class="form-control text-center" name="total" hidden>
								</b></p>
							<hr>

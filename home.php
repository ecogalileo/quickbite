<!-- Masthead-->
<?php 
if($_SERVER['REQUEST_URI'] == "/ecommerce1/index.php?page=home" || "/ecommerce1/index.php"){
?>
...
<section class="page-section" id="menu">
                ...
                <div class="card menu-item  rounded-0">
                    ...
                    <div class="card-body rounded-0">
                        ...
                        <div class="text-center">
                            <button class="btn btn-sm btn-outline-dark view_prod btn-block" data-id=<?php echo $row['id'] ?> <?php if($row['status'] == 0){ echo"disabled"; }?>><i class="fa fa-eye"></i><?php echo ($row['status'] == 0) ? ' Not Available' : ' View' ?></button>
    ...
    <div class="w-100 d-flex justify-content-center">
        <div class="btn-group paginate-btns">
            ...
            <a class="btn btn-default border border-dark" <?php echo ($page == 0) ? 'disabled' : '' ?>
                href="./?_page=<?php echo ($page) ?>">Prev.</a>
            ...
            <?php for ($i = 1; $i <= $page_btn_count; $i++): ?>
                ...
                <?php if ($page_btn_count > 10): ?>
                    ...
                    <?php if ($i == 1 || $i == $page_btn_count || (in_array($i, range(($page - 3), ($page + 3))))): ?>
                        <a class="btn btn-default border border-dark <?php echo ($i == ($page + 1)) ? 'active' : ''; ?>"
                            href="./?_page=<?php echo $i ?>"><?php echo $i; ?></a>
            ...
            <!-- Next Page Button -->
            <a class="btn btn-default border border-dark" <?php echo (($page + 1) == $page_btn_count) ? 'disabled' : '' ?>
                href="./?_page=<?php echo ($page + 2) ?>">Next</a>
